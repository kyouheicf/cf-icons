        ...
        <StyleProvider renderer={renderer}>
          <div className="App">
            ...
            <div class="container" display="grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))' }}>
              <div class="item" key='cloudflare-logo'>
                <div id='cloudflare-logo'>
                  <svg
                    width="61"
                    height="29"
                    viewBox="0 0 61 29"
                ...
                <code>cloudflare-logo</code><br />
                <button value='cloudflare-logo' onClick={e => downloadSvg(document.getElementById(e.target.value).children[0], e.target.value)}>
                  Save as SVG
                </button>
              </div>
              {
